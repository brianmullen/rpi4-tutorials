...
eyeCascade = cv2.CascadeClassifier('/home/brian/code/rpi4-tutorials/Python/haar/haarcascade_eye.xml')
...
while True:
    ...
    for face in faces:
        ...
        eyes = eyeCascade.detectMultiScale(faceGray, 1.1, 5)
        for eye in eyes:
            x, y, w, h = eye
            cv2.rectangle(faceColor, (x, y), (x + w, y + h), (0, 0, 255), 3)
